...
The reader can create :lname:`Idio` values from the various
constructors (integers and strings, say, as we normally think of them
in textual form: 12 and "twelve") and it has a few limited rights to
alter the form of the constructed representation.
